        subroutine restar_stagger (code,  q, ac, lstagger)
c
c----------------------------------------------------------------------
...
c
        write(*,*) 'lstagger IS HERE', lstagger
...
c... END DEBUGGING
cRane     
           write(*,*)  'Calling in restart_stagger', lstagger
           call write_restart_stagger(myrank, lstep, nshg, ndof, 
     &          qold, acold, lstagger)
c           write (irstou) qold
